...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_LUNATONE] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_LUNAR_COLD, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_REGIROCK] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SHAPE_OF_STONE, ABILITY_NONE, ABILITY_STURDY },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_REGICE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SHAPE_OF_ICE, ABILITY_NONE, ABILITY_ICE_BODY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_REGISTEEL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SHAPE_OF_STEEL, ABILITY_NONE, ABILITY_LIGHT_METAL },
        .bodyColor = BODY_COLOR_GRAY,
...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_SCEPTILE] =
    {
        ...
        .innates = { ABILITY_SHARPNESS, ABILITY_GRASSY_SURGE, ABILITY_CHLOROPHYLL},
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Sceptile"),
        .cryId = CRY_SCEPTILE,
        .natDexNum = NATIONAL_DEX_SCEPTILE,
    ...
    [SPECIES_LINOONE] =
    {
        ...
        .abilities = { ABILITY_PICKUP, ABILITY_NONE, ABILITY_QUICK_FEET },
    #endif
        .innates = { ABILITY_QUICK_FEET, ABILITY_DEFIANT, ABILITY_GUTS},
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Linoone"),
        .cryId = CRY_LINOONE,
        .natDexNum = NATIONAL_DEX_LINOONE,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_GARDEVOIR] =
    {
        ...
        .innates = {ABILITY_PIXILATE, ABILITY_DAZZLING, ABILITY_CLEAR_BODY},
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Gardevoir"),
        .cryId = CRY_GARDEVOIR,
        .natDexNum = NATIONAL_DEX_GARDEVOIR,
    ...
    [SPECIES_NINJASK] =
    {
        ...
        .innates = {ABILITY_HYPER_CUTTER, ABILITY_SHARPNESS, ABILITY_SUPER_LUCK},
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Ninjask"),
        .cryId = CRY_NINJASK,
        .natDexNum = NATIONAL_DEX_NINJASK,
    ...
    [SPECIES_EXPLOUD] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_SCRAPPY, ABILITY_NONE},
        .innates = {ABILITY_PUNK_ROCK, ABILITY_INSOMNIA, ABILITY_SOUNDPROOF},
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Exploud"),
        .cryId = CRY_EXPLOUD,
        .natDexNum = NATIONAL_DEX_EXPLOUD,
    ...
    [SPECIES_HARIYAMA] =
    {
        ...
        .innates = {ABILITY_IRON_FIST, ABILITY_GUTS, ABILITY_SHEER_FORCE},
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Hariyama"),
        .cryId = CRY_HARIYAMA,
        .natDexNum = NATIONAL_DEX_HARIYAMA,
    ...
    [SPECIES_PROBOPASS] =
    {
        ...
        .innates = {ABILITY_EARTH_EATER, ABILITY_TRANSISTOR, ABILITY_STATIC_BUILDUP},
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Probopass"),
        .cryId = CRY_PROBOPASS,
        .natDexNum = NATIONAL_DEX_PROBOPASS,
    ...
    [SPECIES_MAWILE] =
    {
        ...
        .innates = {ABILITY_INTIMIDATE, ABILITY_SHEER_FORCE, ABILITY_DISGUISE},
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Mawile"),
        .cryId = CRY_MAWILE,
        .natDexNum = NATIONAL_DEX_MAWILE,
    ...
    [SPECIES_AGGRON] =
    {
        ...
        .innates = { ABILITY_ROCK_HEAD, ABILITY_MIRROR_ARMOR, ABILITY_STEELWORKER},
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Aggron"),
        .cryId = CRY_AGGRON,
        .natDexNum = NATIONAL_DEX_AGGRON,
    ...
    [SPECIES_VOLBEAT] =
    {
        ...
        .innates = {ABILITY_PUNK_ROCK, ABILITY_SWARM, ABILITY_OPPORTUNIST},
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Volbeat"),
        .cryId = CRY_VOLBEAT,
        .natDexNum = NATIONAL_DEX_VOLBEAT,
    ...
    [SPECIES_ROSELIA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_GRASS),
        .abilities = { ABILITY_PHOTOSYNTHESIS, ABILITY_NONE },
        .innates = { ABILITY_FLOWER_VEIL, ABILITY_ESSENCE_OF_SUN, ABILITY_CHLOROPHYLL},
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
        .speciesName = _("Roselia"),
        .cryId = CRY_ROSELIA,
    ...
    [SPECIES_ROSERADE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_GRASS),
        .abilities = { ABILITY_ESSENCE_OF_SUN, ABILITY_NONE },
        .innates = { ABILITY_FLOWER_VEIL, ABILITY_PHOTOSYNTHESIS, ABILITY_CHLOROPHYLL},
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
        .speciesName = _("Roserade"),
        .cryId = CRY_ROSERADE,
    ...
    [SPECIES_SHARPEDO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_NONE, ABILITY_SPEED_BOOST },
        .innates = {ABILITY_STRONG_JAW, ABILITY_ROUGH_SKIN, ABILITY_HUSTLE},
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Sharpedo"),
        .cryId = CRY_SHARPEDO,
        .natDexNum = NATIONAL_DEX_SHARPEDO,
    ...
    [SPECIES_TORKOAL] =
    {
        ...
        .iconSprite = gMonIcon_Torkoal,
        .iconPalIndex = P_GBA_STYLE_SPECIES_ICONS ? 1 : 2,
        .portraitPic = gMonPortraitPic_Torkoal,
        .portraitPal = gMonPortraitPal_Torkoal,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
        SHADOW(2, 7, SHADOW_SIZE_L)
        FOOTPRINT(Torkoal)
        OVERWORLD(
    ...
    [SPECIES_FLYGON] =
    {
        ...
        .innates = {ABILITY_SAND_STREAM, ABILITY_SAND_FORCE, ABILITY_WIND_RIDER},
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Flygon"),
        .cryId = CRY_FLYGON,
        .natDexNum = NATIONAL_DEX_FLYGON,
    ...
    [SPECIES_ALTARIA] =
    {
        ...
        .innates = {ABILITY_CLOUD_NINE, ABILITY_DRAGONS_MAW, ABILITY_SERENE_GRACE},
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Altaria"),
        .cryId = CRY_ALTARIA,
        .natDexNum = NATIONAL_DEX_ALTARIA,
    ...
    [SPECIES_LUNATONE] =
    {
        ...
        .iconSprite = gMonIcon_Lunatone,
        .iconPalIndex = 1,
        .portraitPic = gMonPortraitPic_Lunatone,
        .portraitPal = gMonPortraitPal_Lunatone,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(0, 15, SHADOW_SIZE_S)
        FOOTPRINT(Lunatone)
        OVERWORLD(
    ...
    [SPECIES_SOLROCK] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SUNRISE, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Solrock"),
        .cryId = CRY_SOLROCK,
        .natDexNum = NATIONAL_DEX_SOLROCK,
        ...
        .iconSprite = gMonIcon_Solrock,
        .iconPalIndex = 0,
        .portraitPic = gMonPortraitPic_Solrock,
        .portraitPal = gMonPortraitPal_Solrock,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(0, 15, SHADOW_SIZE_M)
        FOOTPRINT(Solrock)
        OVERWORLD(
    ...
    [SPECIES_WHISCASH] =
    {
        ...
        .iconSprite = gMonIcon_Whiscash,
        .iconPalIndex = 0,
        .portraitPic = gMonPortraitPic_Whiscash,
        .portraitPal = gMonPortraitPal_Whiscash,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(0, 3, SHADOW_SIZE_L)
        FOOTPRINT(Whiscash)
        OVERWORLD(
    ...
    [SPECIES_CRADILY] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_NONE, ABILITY_STORM_DRAIN },
        .innates = {ABILITY_SHELL_ARMOR, ABILITY_MULTISCALE, ABILITY_SEED_SOWER},
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Cradily"),
        .cryId = CRY_CRADILY,
        .natDexNum = NATIONAL_DEX_CRADILY,
    ...
    [SPECIES_MILOTIC] =
    {
        ...
        .abilities = { ABILITY_MARVEL_SCALE, ABILITY_NONE, ABILITY_CUTE_CHARM },
    #endif
        .innates = {ABILITY_DAZZLING, ABILITY_STORM_DRAIN, ABILITY_PIXILATE},
        .bodyColor = BODY_COLOR_PINK,
        .speciesName = _("Milotic"),
        .cryId = CRY_MILOTIC,
        .natDexNum = NATIONAL_DEX_MILOTIC,
    ...
    [SPECIES_CASTFORM_NORMAL] =
    {
        ...
        .innates = { ABILITY_ADAPTABILITY, ABILITY_SERENE_GRACE, ABILITY_HEATPROOF},
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Castform"),
        .cryId = CRY_CASTFORM,
        .natDexNum = NATIONAL_DEX_CASTFORM,
    ...
    [SPECIES_BANETTE] =
    {
        ...
        .abilities = { ABILITY_INSOMNIA, ABILITY_NONE, ABILITY_CURSED_BODY },
    #endif
        .innates = { ABILITY_TOUGH_CLAWS, ABILITY_DISGUISE, ABILITY_INFILTRATOR},
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Banette"),
        .cryId = CRY_BANETTE,
        .natDexNum = NATIONAL_DEX_BANETTE,
    ...
    [SPECIES_TROPIUS] =
    {
        ...
        .iconSprite = gMonIcon_Tropius,
        .iconPalIndex = 1,
        .portraitPic = gMonPortraitPic_Tropius,
        .portraitPal = gMonPortraitPal_Tropius,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-6, 13, SHADOW_SIZE_L)
        FOOTPRINT(Tropius)
        OVERWORLD(
    ...
    [SPECIES_ABSOL] =
    {
        ...
        .abilities = { ABILITY_PRESSURE, ABILITY_NONE, ABILITY_JUSTIFIED },
    #endif
        .innates = {ABILITY_HYPER_CUTTER, ABILITY_SHARPNESS, ABILITY_SNIPER},
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
        .speciesName = _("Absol"),
        .cryId = CRY_ABSOL,
    ...
    [SPECIES_FROSLASS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_HOARFROST, ABILITY_NONE, ABILITY_CURSED_BODY },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Froslass"),
        .cryId = CRY_FROSLASS,
        .natDexNum = NATIONAL_DEX_FROSLASS,
        ...
        .iconSprite = gMonIcon_Froslass,
        .iconPalIndex = 0,
        .portraitPic = gMonPortraitPic_Froslass,
        .portraitPal = gMonPortraitPal_Froslass,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-1, 10, SHADOW_SIZE_S)
        FOOTPRINT(Froslass)
        OVERWORLD(
    ...
    [SPECIES_WALREIN] =
    {
        ...
        .iconSprite = gMonIcon_Walrein,
        .iconPalIndex = 0,
        .portraitPic = gMonPortraitPic_Walrein,
        .portraitPal = gMonPortraitPal_Walrein,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(0, 8, SHADOW_SIZE_L)
        FOOTPRINT(Walrein)
        OVERWORLD(
    ...
    [SPECIES_LUVDISC] =
    {
        ...
        .innates = { ABILITY_PROTEAN, ABILITY_SERENE_GRACE, ABILITY_PRIMORDIAL_SEA},
        .bodyColor = BODY_COLOR_PINK,
        .speciesName = _("Luvdisc"),
        .cryId = CRY_LUVDISC,
        .natDexNum = NATIONAL_DEX_LUVDISC,
    ...
    [SPECIES_SALAMENCE] =
    {
        ...
        .innates = { ABILITY_PRESSURE, ABILITY_MOXIE, ABILITY_JUSTIFIED },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Salamence"),
        .cryId = CRY_SALAMENCE,
        .natDexNum = NATIONAL_DEX_SALAMENCE,
    ...
    [SPECIES_METAGROSS] =
    {
        ...
        .innates = { ABILITY_CLEAR_BODY, ABILITY_PRESSURE, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Metagross"),
        .cryId = CRY_METAGROSS,
        .natDexNum = NATIONAL_DEX_METAGROSS,
    ...
    [SPECIES_REGIROCK] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SHAPE_OF_STONE, ABILITY_NONE, ABILITY_STURDY },
        .innates = { ABILITY_ROCK_HEAD, ABILITY_STAMINA, ABILITY_ROCKY_PAYLOAD },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
        .speciesName = _("Regirock"),
        .cryId = CRY_REGIROCK,
    ...
    [SPECIES_REGICE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SHAPE_OF_ICE, ABILITY_NONE, ABILITY_ICE_BODY },
        .innates = { ABILITY_PRISM_ARMOR, ABILITY_FRIGID_BODY, ABILITY_RESILIENCE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Regice"),
        .cryId = CRY_REGICE,
        .natDexNum = NATIONAL_DEX_REGICE,
    ...
    [SPECIES_REGISTEEL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SHAPE_OF_STEEL, ABILITY_NONE, ABILITY_LIGHT_METAL },
        .innates = { ABILITY_CLEAR_BODY, ABILITY_FILTER, ABILITY_STEELY_SPIRIT },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Registeel"),
        .cryId = CRY_REGISTEEL,
        .natDexNum = NATIONAL_DEX_REGISTEEL,
