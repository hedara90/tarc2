...
const u16 gMetatiles_painted[] = INCBIN_U16("data/tilesets/primary/painted/metatiles.bin");
const u16 gMetatileAttributes_painted[] = INCBIN_U16("data/tilesets/primary/painted/metatile_attributes.bin");
