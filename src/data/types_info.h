...
{//                   Defender -->
 //  Attacker           None   Normal Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy   Stellar
    [TYPE_NONE]     = {______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______},
    [TYPE_NORMAL]   = {______, ______, ______, ______, ______, ______, X(0.5), ______, X(0.25), X(0.5), ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______},
    [TYPE_FIGHTING] = {______, TRC_SE, ______, X(0.5), X(0.5), ______, TRC_SE, X(0.5), X(0.25), TRC_SE, ______, ______, ______, ______, ______, X(0.5), TRC_SE, ______, TRC_SE, X(0.5), ______},
    [TYPE_FLYING]   = {______, ______, TRC_SE, ______, ______, ______, X(0.5), TRC_SE, ______, X(0.5), ______, ______, ______, TRC_SE, X(0.5), ______, ______, ______, ______, ______, ______},
    [TYPE_POISON]   = {______, ______, ______, ______, X(0.5), X(0.5), X(0.5), BUG_RS, X(0.5), X(0.25), ______, ______, ______, TRC_SE, ______, ______, ______, ______, ______, TRC_SE, ______},
    [TYPE_GROUND]   = {______, ______, ______, X(0.25), TRC_SE, ______, TRC_SE, X(0.5), ______, TRC_SE, ______, TRC_SE, ______, X(0.5), TRC_SE, ______, ______, ______, ______, ______, ______},
    [TYPE_ROCK]     = {______, ______, X(0.5), TRC_SE, ______, X(0.5), ______, TRC_SE, ______, X(0.5), ______, TRC_SE, ______, ______, ______, ______, TRC_SE, ______, ______, ______, ______},
    [TYPE_BUG]      = {______, ______, X(0.5), X(0.5), PSN_RS, ______, ______, ______, X(0.5), X(0.5), ______, X(0.5), ______, TRC_SE, ______, TRC_SE, ______, ______, TRC_SE, X(0.5), ______},
    [TYPE_GHOST]    = {______, X(0.25), ______, ______, ______, ______, ______, ______, TRC_SE, STL_RS, ______, ______, ______, ______, ______, PSY_RS, ______, ______, X(0.5), ______, ______},
    [TYPE_STEEL]    = {______, ______, ______, ______, ______, ______, TRC_SE, ______, ______, X(0.5), ______, X(0.5), X(0.5), ______, X(0.5), ______, TRC_SE, ______, ______, TRC_SE, ______},
    [TYPE_MYSTERY]  = {______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______},
    [TYPE_FIRE]     = {______, ______, ______, ______, ______, ______, X(0.5), TRC_SE, ______, TRC_SE, ______, X(0.5), X(0.5), TRC_SE, ______, ______, TRC_SE, X(0.5), ______, ______, ______},
    [TYPE_WATER]    = {______, ______, ______, ______, ______, TRC_SE, TRC_SE, ______, ______, ______, ______, TRC_SE, X(0.5), X(0.5), ______, ______, ______, X(0.5), ______, ______, ______},
    [TYPE_GRASS]    = {______, ______, ______, X(0.5), X(0.5), TRC_SE, TRC_SE, X(0.5), ______, X(0.5), ______, X(0.5), TRC_SE, X(0.5), ______, ______, ______, X(0.5), ______, ______, ______},
    [TYPE_ELECTRIC] = {______, ______, ______, TRC_SE, ______, X(0.25), ______, ______, ______, ______, ______, ______, TRC_SE, X(0.5), X(0.5), ______, ______, X(0.5), ______, ______, ______},
    [TYPE_PSYCHIC]  = {______, ______, TRC_SE, ______, TRC_SE, ______, ______, ______, ______, X(0.5), ______, ______, ______, ______, ______, X(0.5), ______, ______, X(0.25), ______, ______},
    [TYPE_ICE]      = {______, ______, ______, TRC_SE, ______, TRC_SE, ______, ______, ______, X(0.5), ______, FIR_RS, X(0.5), TRC_SE, ______, ______, X(0.5), TRC_SE, ______, ______, ______},
    [TYPE_DRAGON]   = {______, ______, ______, ______, ______, ______, ______, ______, ______, X(0.5), ______, ______, ______, ______, ______, ______, ______, TRC_SE, ______, X(0.25), ______},
    [TYPE_DARK]     = {______, ______, X(0.5), ______, ______, ______, ______, ______, TRC_SE, STL_RS, ______, ______, ______, ______, ______, TRC_SE, ______, ______, X(0.5), X(0.5), ______},
    [TYPE_FAIRY]    = {______, ______, TRC_SE, ______, X(0.5), ______, ______, ______, ______, X(0.5), ______, X(0.5), ______, ______, ______, ______, ______, TRC_SE, TRC_SE, ______, ______},
    [TYPE_STELLAR]  = {______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______},
};
