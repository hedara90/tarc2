...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_CHESNAUGHT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PHALANX, ABILITY_NONE },
        .innates = { ABILITY_IRON_BARBS, ABILITY_STAMINA, ABILITY_DAUNTLESS_SHIELD},
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_DELPHOX] =
    {
        ...
        .innates = { ABILITY_FLASH_FIRE, ABILITY_INFERNO, ABILITY_FLARE_BOOST},
        .bodyColor = BODY_COLOR_RED,
...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                       \
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),                           \
        .abilities = { ABILITY_FLORAL_GROWTH, ABILITY_NONE, ABILITY_FLORAL_GROWTH },  \
        .bodyColor = BODY_COLOR_WHITE,                                          \
        ...
        .iconPalIndex = iconPal,                                                \
        .portraitPic = gMonPortraitPic_Florges,                                 \
        .portraitPal = gMonPortraitPal_Florges,                                 \
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,                                 \
    ...
    [SPECIES_GOGOAT] =
    {
        ...
        .innates = {ABILITY_GRASS_PELT, ABILITY_STAMINA, ABILITY_RESILIENCE},
        .bodyColor = BODY_COLOR_BROWN,
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    {                                                                                                   \
        ...
        .innates = { ABILITY_SCRAPPY, ABILITY_NORMALIZE, ABILITY_GOOD_AS_GOLD},                         \
        .bodyColor = BODY_COLOR_WHITE,                                                                  \
        .noFlip = _noFlip,                                                                              \
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_AEGISLASH_SHIELD] =
    {
        ...
        .innates = { ABILITY_MENTAL_SWORD, ABILITY_CURSED_BODY, ABILITY_WILLPOWER},
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_MALAMAR] =
    {
        ...
        .innates = { ABILITY_EMPATH, ABILITY_DREAD, ABILITY_COLOR_CHANGE},
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DRAGALGE] =
    {
        ...
        .innates = { ABILITY_CRIPPLING_VENOM, ABILITY_CORROSION, ABILITY_TOXIC_CHAIN},
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CLAWITZER] =
    {
        ...
        .innates = { ABILITY_MISTBANK, ABILITY_WEAK_ARMOR, ABILITY_SNIPER},
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    [SPECIES_HELIOLISK] =
    {
        ...
        .iconPalIndex = 2,
        .portraitPic = gMonPortraitPic_Heliolisk,
        .portraitPal = gMonPortraitPal_Heliolisk,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(-2, 10, SHADOW_SIZE_M)
        FOOTPRINT(Heliolisk)
        OVERWORLD(
    ...
    [SPECIES_AURORUS] =
    {
        ...
        .innates = { ABILITY_SNOW_WARNING, ABILITY_SOLID_ROCK, ABILITY_HOARFROST},
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GOURGEIST_AVERAGE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_FLAME_CLOAK, ABILITY_NONE },
        .innates = { ABILITY_CURSED_BODY, ABILITY_DISGUISE, ABILITY_FLASH_FIRE},
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_NOIVERN] =
    {
        ...
        .innates = { ABILITY_PUNK_ROCK, ABILITY_SOUNDPROOF, ABILITY_FILTER},
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_XERNEAS_NEUTRAL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_CIRCLE_OF_LIFE2, ABILITY_NONE, ABILITY_NONE },
        .innates = { ABILITY_YGGDRASILS_GIFT2, ABILITY_AURA_OF_VITALITY, ABILITY_ABUNDANCE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DIANCIE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_FRACTAL_SHARDS, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_PINK,
        ...
        .iconPalIndex = 1,
        .portraitPic = gMonPortraitPic_Diancie, 
        .portraitPal = gMonPortraitPal_Diancie,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
