...
const u8 gText_BattleStyle[] = _("SHOW DEBUG INFO");
const u8 gText_Sound[] = _("SOUND");
const u8 gText_Frame[] = _("SPEEDUP");
...
const u8 gText_DebugOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_DebugOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
