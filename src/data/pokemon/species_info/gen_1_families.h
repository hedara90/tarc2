...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
    ...
    [SPECIES_ARTICUNO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_HAILSTONE_FALL, ABILITY_HAILSTONE_FALL, ABILITY_HAILSTONE_FALL },
    ...
    [SPECIES_MOLTRES] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_FLAMES_EMBRACE, ABILITY_FLAMES_EMBRACE, ABILITY_FLAMES_EMBRACE },
