...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_SLEET_STORM]                          = COMPOUND_STRING("Sleet falls all over the area!"),
    ...
    [STRINGID_ESSENCE_OF_SUN_ENTER]                 = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} carries the Essence of Sun!"),
    ...
    [STRINGID_GENEROSITY_BURN]                      = COMPOUND_STRING("The opposing Delibird is happy with its generous burn!"),
    [STRINGID_GENEROSITY_FROSTBITE]                 = COMPOUND_STRING("The opposing Delibird is happy with its generous frostbite!"),
    [STRINGID_GENEROSITY_PARALYSIS]                 = COMPOUND_STRING("The opposing Delibird is happy with its generous paralysis!"),
...
const u16 gSwitchInAbilityStringIds[] =
{
    ...
    [B_MSG_SWITCHIN_ESSENCE_OF_SUN] = STRINGID_ESSENCE_OF_SUN_ENTER,
    [B_MSG_SWITCHIN_ESSENCE_OF_RAIN] = STRINGID_ESSENCE_OF_RAIN_ENTER,
    [B_MSG_SWITCHIN_ESSENCE_OF_SNOW] = STRINGID_ESSENCE_OF_SNOW_ENTER,
    [B_MSG_SWITCHIN_ESSENCE_OF_SAND] = STRINGID_ESSENCE_OF_SAND_ENTER,
};
...
const u16 gWrappedStringIds[NUM_TRAPPING_MOVES] =
{
    ...
    [B_MSG_WRAPPED_FIRE_SPIN2]   = STRINGID_PKMNTRAPPEDINVORTEX,    // MOVE_FIRE_SPIN
};
