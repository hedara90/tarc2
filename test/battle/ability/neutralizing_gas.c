...
DOUBLE_BATTLE_TEST("Neutralizing Gas ignores all battlers' ability effects")
{
    GIVEN {
        ...
        PLAYER(SPECIES_WOBBUFFET) { Ability(ABILITY_NEUTRALIZING_GAS); }
        PLAYER(SPECIES_WYNAUT) { Ability(ABILITY_TELEPATHY); }
        OPPONENT(SPECIES_WOBBUFFET) { Ability(ABILITY_WATER_ABSORB); }
...
DOUBLE_BATTLE_TEST("Neutralizing Gas ignores all battlers' ability effects (Trait)")
{
    GIVEN {
        ASSUME(GetMoveTarget(MOVE_SURF) == MOVE_TARGET_FOES_AND_ALLY);
        PLAYER(SPECIES_WOBBUFFET) { Ability(ABILITY_LEVITATE); Innates(ABILITY_NEUTRALIZING_GAS); }
        PLAYER(SPECIES_WYNAUT) { Ability(ABILITY_TELEPATHY); }
        OPPONENT(SPECIES_WOBBUFFET) { Ability(ABILITY_WATER_ABSORB); }
        OPPONENT(SPECIES_WYNAUT) { Ability(ABILITY_ELECTROMORPHOSIS); }
    } WHEN {
