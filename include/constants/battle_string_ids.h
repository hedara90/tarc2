...
enum StringID
{
    ...
    STRINGID_BOSSWILLRESTORE,
    STRINGID_BOSSRESTORED,
    STRINGID_RESTORE_BACKLINE,
    STRINGID_SLEET_STORM,
    STRINGID_THUNDERSTRIKE,
    STRINGID_INFERNO,
    STRINGID_CD_OVERRIDE,
    STRINGID_RESS_MON,
    STRINGID_CLOUDWALKER,
    STRINGID_CLOUDWALKER_TRIGGER,
    STRINGID_SPARKING_ZEPHYR,
    STRINGID_UNCONTAINED_BLAZE,
    STRINGID_MENTAL_RESET,
    STRINGID_STATIC_BUILDUP,
    STRINGID_LUNAR_COLD,
    STRINGID_ICYVEINSHPDROP,
    STRINGID_RESORPTION,
    STRINGID_FATED_CHANGE,
    STRINGID_FATED_STRIKE,
    STRINGID_FATED_SIGHT,
    STRINGID_FRACTAL_SHARDS,
    STRINGID_CIRCLE_OF_LIFE,
    STRINGID_YGGDRASIL,
    STRINGID_SANCTUARY,
    STRINGID_HEALING_SPIRIT,
    STRINGID_ABUNDANCE,
    STRINGID_SHACKLED,
    STRINGID_APPLY_SUBMERGED,
    STRINGID_EOT_SUBMERGED,
    STRINGID_TSUNAMI,
    STRINGID_THE_SPACE_BETWEEN,
    STRINGID_LIVING_SHADOW_ENTERS,
    STRINGID_DIMENSIONAL_PRISON_RELEASE,
    STRINGID_BANISH,
    STRINGID_PURIFYING_WATER,
    STRINGID_EMPATH_HEAL,
    STRINGID_TERRAS_BLESSING,
    STRINGID_RAINSTARTEDPOURING,
    STRINGID_ESSENCE_OF_SUN_ENTER,
    STRINGID_ESSENCE_OF_RAIN_ENTER,
    STRINGID_ESSENCE_OF_SNOW_ENTER,
    STRINGID_ESSENCE_OF_SAND_ENTER,
    STRINGID_GENEROSITY_BURN,
    STRINGID_GENEROSITY_FROSTBITE,
    STRINGID_GENEROSITY_PARALYSIS,
    STRINGID_GENEROSITY_NOTHING,
    STRINGID_GENEROSITY_NOTHING2,
    STRINGID_GENEROSITY_BURN2,
    STRINGID_GENEROSITY_FROSTBITE2,
    STRINGID_GENEROSITY_PARALYSIS2,
    STRINGID_ATTENTION,
    STRINGID_COUNT
};
...
enum SwitchInAbilityStringID
{
    ...
    B_MSG_SWITCHIN_ESSENCE_OF_SUN,
    B_MSG_SWITCHIN_ESSENCE_OF_RAIN,
    B_MSG_SWITCHIN_ESSENCE_OF_SNOW,
    B_MSG_SWITCHIN_ESSENCE_OF_SAND,
};
