...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_SANCTUARY] =
    {
        ...
        .contestComboStarterId = COMBO_STARTER_GRASSY_TERRAIN,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_Sanctuary,
    },
    [MOVE_HEALING_SPIRIT] =
    {
        .name = COMPOUND_STRING("Healing Spirit"),
        .description = COMPOUND_STRING(
            "All battlers recover\n"
            "half of max HP."),
        .effect = EFFECT_HEALING_SPIRIT,
        .power = 0,
        .type = TYPE_FAIRY,
        .accuracy = 0,
        .pp = 10,
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_HealingSpirit,
    },
    [MOVE_MIND_LOCK] =
    {
    ...
    [MOVE_MIND_STEAL] =
    {
        ...
        .argument.twoTurnAttack = { .stringId =  STRINGID_PKMNSPRANGUP, .status = COMPRESS_BITS(STATUS3_ON_AIR) },
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_STAT_STEAL,
            .chance = 100,
            .sheerForceBoost = SHEER_FORCE_NO_BOOST,
        }),
        .contestEffect = CONTEST_EFFECT_AVOID_STARTLE,
    ...
    {
        .name = COMPOUND_STRING("Dimension Break"),
        .description = COMPOUND_STRING(
            "Vanishes, then breaks\n"
            "reality on return to\n"
            "attack the foe."),
        .effect = EFFECT_SEMI_INVULNERABLE,
        .power = 90,
        .type = TYPE_DRAGON,
        ...
        .instructBanned = TRUE,
        .assistBanned = TRUE,
        .argument.twoTurnAttack = { .stringId =  STRINGID_PKMNFLEWHIGH, .status = COMPRESS_BITS(STATUS3_PHANTOM_FORCE) },
        .contestEffect = CONTEST_EFFECT_STARTLE_MON_WITH_JUDGES_ATTENTION,
        .contestCategory = CONTEST_CATEGORY_COOL,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_HORN_ATTACK, COMBO_STARTER_PECK},
        .battleAnimScript = gBattleAnimMove_DimensionBreak,
    },
    [MOVE_BANISH] =
    {
        .name = COMPOUND_STRING("Banish"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Planar Imprisonment"),
        .description = COMPOUND_STRING(
            "Banishes all non-active\n"
            "battlers."),
        .effect = EFFECT_PLANAR_IMPRISONMENT,
        .power = 0,
        .type = TYPE_GHOST,
        .accuracy = 100,
        .pp = 20,
    ...
    [MOVE_RED_PRESENT] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_RAIN_DANCE},
        .battleAnimScript = gBattleAnimMove_RedPresent,
    },
    [MOVE_BLUE_PRESENT] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_RAIN_DANCE},
        .battleAnimScript = gBattleAnimMove_BluePresent,
    },
    [MOVE_YELLOW_PRESENT] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_RAIN_DANCE},
        .battleAnimScript = gBattleAnimMove_YellowPresent,
    },
};
